...
const Header = () => {
  ...
  return (
    <header className="w-full">
      {/* Top bar */}
      <div className="bg-[#1F1B2E] text-white text-sm py-2 px-4 flex justify-between items-center lg:px-10">
        <div className="hidden lg:block">
          ✔ Free Shipping On All Orders Over $50
        </div>
        <div className="flex justify-center w-full lg:w-auto space-x-6">
      ...
      <div className="max-w-[1321px] mx-auto mt-4 hidden lg:flex justify-between items-center">
        ...
        {/* Contact - Right side */}
        <div className="w-45 h-8">Contact: (805) 444-1222</div>
      </div>
